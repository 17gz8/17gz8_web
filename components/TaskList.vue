...
export default {
  ...
  //         this.$emit('getCurrentInfo', res.data.list[0])
  //       } else {
  //         this.tableData.length = 0
  //         this.$emit('getCurrentInfo', false)
  //       }
  //     }).catch(() => { })
  //       .finally(() => {
  //         this.loading = false
